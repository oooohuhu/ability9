 ...
 */
public class GMapActivity extends AppCompatActivity implements  AMapNaviListener {
    ...
    private TextView rl_tv_end;
    private TextView rl_tv_start;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMapView = (AMapNaviView) findViewById(R.id.gmap);
